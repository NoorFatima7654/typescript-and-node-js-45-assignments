 ...
 //Task # 2
//Personal Message: Store a person’s name in a variable, and print a message to that person. Your message should
...
//Task # 3
 ...
 //Task # 4
  //Famous Quote: Find a quote from a famous person you admire. Print the quote and the name of its author. Your output
...
// one comment to each. If you don’t have anything specific to write because
 //your programs are too simple at this point, just add your name and the
...
// time.
  ...
  let names : string [] = ["Mishal","Arish","Anabiya","Laiba"];
 console.log(names[0]);
 console.log(names[1]);
console.log(names[2]);
 console.log(names[3]);
...
//person’s nam
 ...
 let message : string = "Do you like a play football?"
...
// list to print a series of statements about these items, such as “I would 
 ...
 let transportation : string [] = ["Honda motarcycle","Audi","Honda city"]
...
let guestArr : string [] = ["Mishal","Arish","Anabiya"];
...
let guestArr : string[] = ["Bisma","Iqra","Fatima","Huzaifa"];
...
//• Start with your program from Exercise 15. Add a print statement to the end 
 ...
 let guestArr : string[] = ["Alishba","Iqra","Fatima","Huzaifa"]; 

  let canNotAttend : string =  "Iqra"
   let newGuest : string = "Arish"
...
let guests: string[] = ["Ali","Bilal","Saqib","Dawood","Hamza"];
...
//Printing invitation to the remaining guest.
...
//Task # 18
 ...
 //print the array in reverse alphabrtical order without chnging the order of the orignal list
 console.log("Reverse alphabetical order:", [...placesTovisit].sort().reverse());
 //show that the Arry in still in orignal order by printing it again
...
these items.
let person:{name: string, fname: string, age: number} = {name: "noor fatima", fname:"female", age:27}
console.log(person) 
...
//try more comparisons, write more tests. Have at least one True and one False result for each of the following:
 ...
 let name_1 : string = "noor"
let name_2 :string ="noor fatima"
let name_3 : string ="miss noor fatima"
...
if (age_1 == 18 || age_2 == 22) {
 ...
 // Test weather an item in an array
...
if (alien_color == "green") {
 ...
 //• If the alien is yellow, print a message that the player earned 10 points.let alien_color: string = "green"
...
//• If the person is at least 2 years old but less than 4, print a message that the person toddler
//is a kid.
 let age :number = 3
if (age < 2){
     console.log("you are a baby")
 ...
 //• If the person is at least 4 years old but less than 13, print a message that the person kid
 let age :number = 12
 if (age < 2){
    console.log("you are a baby")
 } else if (age < 4){
...
//read "1 2nd 3rd 4th 5th 6th 7th 8th 9th", and each result should be on a separate line.
...
describe_city('Karachi')//default sentance
